...
angular.module('starter', ['ionic','ngIOS9UIWebViewPatch', 'starter.controllers', 'starter.services', 'ngMaterial', 'ngMessages', 'ngCordova', 'chart.js', 'ngStorage'])
    ...
    .config(function ($ionicConfigProvider, $stateProvider, $urlRouterProvider, $mdThemingProvider, $mdIconProvider, $mdColorPalette, $mdIconProvider) {
        ...
        $stateProvider
            ...
            .state('app.funds', {
                ...
                views: {
                    'menuContent': {
                        templateUrl: "templates/funds/html/funds.html",
